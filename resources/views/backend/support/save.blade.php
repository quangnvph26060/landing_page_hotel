...
@section('content')
    @include('backend.layouts.partials.breadcrumb', [
       'page' => isset($support)? 'Sửa bài viết' : 'Thêm bài viết',
    ...
    @php
        $action = isset($support) ? route('admin.support.update', $support) : route('admin.support.store');
    @endphp
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="info" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-6">
                                        ...
                                        <input value="{{ $support->title ?? '' }}" oninput="convertSlug('#title', '#slug')"
                                    ...
                                    <div class="form-group mb-3 col-lg-6">
                                        ...
                                        <input id="slug" value="{{ $support->slug ?? '' }}" name="slug"
                                            class="form-control" type="text" placeholder="Đường dẫn thân thiện">
                                    </div>

                                    <div class="form-group mb-3 col-lg-12">
                                        <label for="slug" class="form-label">Mô tả chi tiết</label>
                                        <textarea name="description" class="form-control ckeditor" id="description" placeholder="Mô tả ">{!! $support->description ?? '' !!}</textarea>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="seo" role="tabpanel" aria-labelledby="seo-tab">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{ $support->title_seo ?? '' }}"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description_seo" id="description_seo" cols="30" rows="4" class="form-control ckeditor"
                                        placeholder="Mô tả seo">{{ $support->description_seo ?? '' }}</textarea>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="keyword_seo" class="form-label">Keyword</label>
                                    <input id="keyword_seo" value="{{ $support->keyword_seo ?? '' }}"
                                        name="keyword_seo">
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <select name="status" id="status" class="form-select">
                            <option value="1" @selected(($support->status ?? 1) == 1)>Xuất bản</option>
                            <option value="2" @selected(($support->status ?? 2) == 2)>Chưa xuất bản</option>
                        </select>
                    </div>
                </div>
